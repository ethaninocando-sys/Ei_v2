...
export const metadata: Metadata = {
  title: "Why local SEO works",
  description:
    "Why ranking in the top 3 on Google matters, how our process works, a real client case study, and answers to the questions Rio Grande Valley business owners ask most.",
};
